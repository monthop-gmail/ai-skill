...
Meta-module ที่ติดตั้ง Thai Accounting ทุกตัวในคลิกเดียว อยู่ใน repo [monthop-gmail/accsumana-addons](https://github.com/monthop-gmail/accsumana-addons) (clone อัตโนมัติตอน build)
...
> **หมายเหตุ:** `l10n_th_mis_report` ยัง comment ไว้ใน depends เพราะรอ `mis_builder` port ไป 19.0
...
├── Dockerfile                      # custom image + OCA modules + accsumana-addons
